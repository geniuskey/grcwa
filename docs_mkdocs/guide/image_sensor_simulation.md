...
![이미지 센서 픽셀 구조](../assets/images/sensor_structure.png)

*이미지 센서 픽셀의 단면 구조: 마이크로렌즈가 입사광을 포토다이오드 영역으로 집광하고, 컬러 필터가 파장을 선택하며, 금속 배선 층이 전기 신호를 전달합니다.*
...
![Bayer 패턴 배열](../assets/images/bayer_pattern.png)

*Bayer 패턴: GRGB 2×2 최소 단위 셀이 주기적으로 반복됩니다. 노란색 점선은 시뮬레이션에 사용되는 단위 셀을 나타냅니다.*
